...
public class RegisterActivity extends ActionBarBaseActivity implements View.OnClickListener, AsyncTaskCompleteListener{
    ...
    private EditText edtRegisterUserName, edtRegisterEmail, edtRegisterPassword,
            edtRegisterConformPassword, edtRegisterConatctNo , edtRegisterAddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        camera = (ImageView) findViewById(R.id.imgUserPhoto);
    ...
    //Pass data entered into edit text to string
    public void registerUser(View view){
        userName = edtRegisterUserName.getText().toString();
        userEmail = edtRegisterEmail.getText().toString();
        userPassword = edtRegisterPassword.getText().toString();
        userContact = edtRegisterConatctNo.getText().toString();
        userAddress = edtRegisterAddress.getText().toString();

        String method = "register";

        //Create an object of background Task
        BackgroundTask backgroundTask = new BackgroundTask(this);
        backgroundTask.execute(method, edtRegisterUserName, edtRegisterEmail, edtRegisterPassword,
                edtRegisterConatctNo, edtRegisterAddress);
        finish();
    ...
    private void addNotification() {
        ...
        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(this)
                        ...
                        .setContentTitle("Jimmie jobs says:")
                        .setPriority(NotificationCompat.PRIORITY_HIGH)
                        .setAutoCancel(true)
                        .setSound(soundUri)
                        .setContentText("Thank you for registering into our system");
...
try{
    AndyUtils.showCustomProgressDialog(this , false);
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED ||
            ...
            ActivityCompat.requestPermissions(this, new String[]{android.Manifest.permission.CAMERA, android.Manifest.permission.WRITE_EXTERNAL_STORAGE},
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
                ...
                imgUserPhoto.setImageBitmap(imageBitmap);
            }
        ...
        } else if (requestCode == Const.TAKE_PHOTO && data != null) {
